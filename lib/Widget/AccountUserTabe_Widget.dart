...
import 'package:webshop/Controller/AccountUser_Controller.dart';

class  AccountUserTable extends StatelessWidget {
  final AccountUserController accountUserController = Get.put( AccountUserController());
  final scrollController = ScrollController(initialScrollOffset: 0);
  @override
  Widget build(BuildContext context) {
    Future.delayed(Duration.zero, () async {
      await accountUserController.fetchAccountShipper();
    });
    return Container(
      child: Obx(() {
        if ( accountUserController.isLoading.value)
          return Center(
                ...
                child: Scrollbar(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      rows:  accountUserController.userList
